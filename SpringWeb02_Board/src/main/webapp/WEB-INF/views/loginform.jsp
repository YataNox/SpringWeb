...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="resources/css/board.css"><!-- 시작위치 : webapp폴더 기준 -->
	...
	<body>
		<form action="login" method="post" name="frm">
			...
			<div class="box2">
				...
				<div class="attr2">&nbsp;&nbsp;<input type="text" size="20" name="id" style="width:200px; height:20px;"></div>
			</div>
